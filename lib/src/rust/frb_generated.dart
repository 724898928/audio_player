...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1190807334;
...
abstract class RustLibApi extends BaseApi {
  Stream<String> crateApiSimpleAddSongs({required List<String> songs});

  Stream<String> crateApiSimpleDelSong({required BigInt idx});

  Stream<String> crateApiSimpleGetPos();

  String crateApiSimpleGetSongMetadata({required String filePath});

  Future<String> crateApiUtilsGetSongMetadata({required String filePath});

  Duration crateApiSimpleGetTotalLen();

  String crateApiSimpleHttpGet({required String url});

  Future<String> crateApiUtilsHttpGet({required String url});
  ...
  Stream<String> crateApiSimpleSetVolume({required double v});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Stream<String> crateApiSimpleAddSongs({required List<String> songs}) {
    ...
    handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleAddSongsConstMeta,
  ...
  TaskConstMeta get kCrateApiSimpleAddSongsConstMeta => const TaskConstMeta(
        debugName: "add_songs",
        argNames: ["songs", "sink"],
      );
  ...
  Stream<String> crateApiSimpleDelSong({required BigInt idx}) {
    ...
    handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleDelSongConstMeta,
      argValues: [idx, sink],
      apiImpl: this,
    ));
    return sink.stream;
  ...
  TaskConstMeta get kCrateApiSimpleDelSongConstMeta => const TaskConstMeta(
        debugName: "del_song",
        argNames: ["idx", "sink"],
      );
  ...
  String crateApiSimpleGetSongMetadata({required String filePath}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleGetSongMetadataConstMeta,
      argValues: [filePath],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleGetSongMetadataConstMeta =>
      const TaskConstMeta(
        debugName: "get_song_metadata",
        argNames: ["filePath"],
      );
  ...
  Future<String> crateApiUtilsGetSongMetadata({required String filePath}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiUtilsGetSongMetadataConstMeta,
      argValues: [filePath],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUtilsGetSongMetadataConstMeta =>
      const TaskConstMeta(
        debugName: "get_song_metadata",
        argNames: ["filePath"],
      );
  ...
  String crateApiSimpleHttpGet({required String url}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleHttpGetConstMeta,
      argValues: [url],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleHttpGetConstMeta => const TaskConstMeta(
        debugName: "http_get",
        argNames: ["url"],
      );
  ...
  Future<String> crateApiUtilsHttpGet({required String url}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiUtilsHttpGetConstMeta,
      argValues: [url],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUtilsHttpGetConstMeta => const TaskConstMeta(
        debugName: "http_get",
        argNames: ["url"],
      );
  ...
  TaskConstMeta get kCrateApiSimpleSetVolumeConstMeta => const TaskConstMeta(
